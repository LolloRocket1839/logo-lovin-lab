...
var blogPosts = [
  {
    ...
    translations: {
      it: {
        ...
        faqs: [
          { question: "Posso vendere un immobile prima di chiudere la successione?", answer: "No. Serve la dichiarazione di successione registrata e la voltura catastale: senza queste il notaio non pu\xF2 procedere al rogito." },
          ...
          { question: "Cosa succede se un erede non vuole vendere?", answer: "Per vendere l'intero immobile servono tutti i comproprietari. Le alternative sono la divisione ereditaria, con un erede che liquida gli altri, oppure la divisione giudiziale davanti al giudice, che per\xF2 richiede anni." },
  ...
  },
  {
    ...
    translations: {
      it: {
        ...
        excerpt: "19% di detrazione IRPEF su massimo 2.633 euro di canone, fino a 500 euro di risparmio. Quali contratti valgono, requisiti dei 100 km, tracciabilit\xE0 e documenti da conservare.",
        seo: {
          ...
          keywords: ["detrazione affitto studenti fuori sede", "detrazione IRPEF 19% affitto", "2.633 euro detrazione affitto", "requisito 100 km universit\xE0", "730 rigo E8 codice 18", "detrazione posto letto studente"]
        },
        tags: ["Studenti", "Fisco", "Detrazioni", "Contratti", "730"],
        faqs: [
          { question: "Quanto si detrae dall'affitto da studente fuori sede?", answer: "Il 19% del canone pagato, su una spesa massima di 2.633 euro l'anno: la detrazione massima \xE8 500,27 euro. Il tetto vale per contribuente, non per figlio o per contratto." },
          { question: "Serve un contratto specifico per studenti?", answer: "No. Va bene qualsiasi locazione abitativa registrata ai sensi della Legge 431/1998: 4+4 libero, 3+2 concordato, transitorio e transitorio studenti. Anche il contratto per una singola stanza o un posto letto \xE8 detraibile." },
          { question: "La sublocazione d\xE0 diritto alla detrazione?", answer: "No. L'Agenzia delle Entrate ha escluso il subaffitto perch\xE9 non rientra tra gli schemi contrattuali previsti dalla norma (Circolare 21/E/2010, risposta 4.3, ribadita nella Circolare 14/E/2023)." },
          { question: "Quali sono i requisiti di distanza?", answer: "L'universit\xE0 deve trovarsi in un Comune diverso da quello di residenza, distante almeno 100 km e in una provincia diversa. Le due condizioni valgono insieme. La deroga a 50 km per zone montane non \xE8 pi\xF9 in vigore." },
