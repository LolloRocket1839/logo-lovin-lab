...
const FAQS = [
  ...
  { category: "investors", q_it: "Jungle Rent è un investimento sicuro?", q_en: "Is Jungle Rent a safe investment?", a_it: "Jungle Rent è iscritta nella sezione speciale delle start-up innovative ed è incubata presso 2i3T. I rendimenti dipendono dal mercato e non sono garantiti.", a_en: "Jungle Rent is registered in the special section for innovative startups and incubated at 2i3T. Returns depend on market performance and are not guaranteed." },
  { category: "sellers", q_it: "Come posso vendere casa a Torino senza agenzia?", q_en: "How can I sell my house in Turin without an agency?", a_it: "Jungle Rent acquista direttamente il tuo immobile senza commissioni. Range di prezzo indicativo entro 48 ore dal contatto, una visita, proposta scritta e rogito in 60-90 giorni.", a_en: "Jungle Rent directly purchases your property with no fees. Indicative price range within 48 hours of contact, one visit, a written offer and closing in 60-90 days." },
  ...
  { category: "about", q_it: "Jungle Rent è affidabile?", q_en: "Is Jungle Rent reliable?", a_it: "Jungle Rent S.r.l. è iscritta nel Registro Imprese e nella sezione speciale delle start-up innovative, P.IVA 13333450016, ed è incubata presso 2i3T (Università di Torino).", a_en: "Jungle Rent S.r.l. is registered in the Business Register and in the special section for innovative startups, P.IVA 13333450016, and is incubated at 2i3T (University of Turin)." },
];
