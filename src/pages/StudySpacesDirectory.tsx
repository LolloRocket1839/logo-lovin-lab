...
const StudySpacesDirectory = () => {
  ...
  const content = {
    it: {
      ...
      sessioneEsami: 'Durante le sessioni d\'esami (Gen-Feb, Giu-Lug, Set) le sale EDISU Verdi e Michelangelo restano aperte fino alle 2:00. Consulta EDISU per conferma.',
      contattoConsigliato: 'Si consiglia contatto telefonico prima della visita. Orari soggetti a variazioni stagionali.',
      ultimoAggiornamento: 'Ultimo aggiornamento: Marzo 2026',
    ...
    en: {
      ...
      sessioneEsami: 'During exam sessions (Jan-Feb, Jun-Jul, Sep) EDISU Verdi and Michelangelo halls stay open until 2:00 AM. Check EDISU for confirmation.',
      contattoConsigliato: 'We recommend calling before visiting. Hours may vary by season.',
      ultimoAggiornamento: 'Last updated: March 2026',
