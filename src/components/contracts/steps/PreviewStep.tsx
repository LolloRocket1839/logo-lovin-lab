...
import { FileText, Home, Users, Euro, CheckCircle } from "lucide-react";
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {lang === 'it'
                ? 'Cliccando "Genera contratto" riceverai il contratto redatto via email entro 48 ore. Potrai richiedere revisioni gratuite.'
                : 'By clicking "Generate contract" you will receive the drafted contract via email within 48 hours. You can request free revisions.'}
            </p>
          </div>
        </div>
      </Card>
