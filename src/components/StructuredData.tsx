...
export const StructuredData = () => {
  useEffect(() => {
    ...
    const organizationSchema = {
      ...
      url: BASE_URL,
      logo: `${BASE_URL}/jungle-rent-logo.svg`,
    ...
    const localBusinessSchema = {
      ...
      legalName: "JUNGLE RENT SOCIETA' A RESPONSABILITA' LIMITATA",
      image: `${BASE_URL}/jungle-rent-logo.svg`,
      description:
      ...
      step: [
        {
          ...
          url: `${BASE_URL}/valutazione-immobile`
        },
        {
          "@type": "HowToStep",
          position: 2,
    ...
    const breadcrumbSchema = {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": `${BASE_URL}/#student-section`
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Investitori",
          "item": `${BASE_URL}/#investor-section`
        },
        {
          "@type": "ListItem",
          "position": 4,
          "name": "Venditori",
          "item": `${BASE_URL}/#seller-section`
        }
      ]
    };
    ...
    const propsAppSchema = {
      ...
      isAccessibleForFree: true,
      url: `${BASE_URL}/blog/props-gestione-immobiliare-semplificata`,
    ...
    const webSiteSchema = {
      ...
      "speakable": {
        ...
        "cssSelector": ["h1", "[data-speakable='true']", "[data-ai-summary]"]
      }
    };
