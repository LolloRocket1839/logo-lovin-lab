...
const filterTexts = {
 ...
 const InvestorZonesMap: React.FC<InvestorZonesMapProps> = ({ 
  ...
  const [legendOpen, setLegendOpen] = useState(false);
   ...
   }, [filteredZones, lang, selectedZoneIds, onZoneClick, zonesPath, t]);
    ...
    return (
      <div className="relative w-full h-[450px] md:h-[500px] rounded-lg overflow-hidden">
       ...
       <div className="absolute top-4 right-4 z-[400] flex items-center gap-2">
        ...
        {/* Mobile legend toggle — collapsed by default */}
        {!legendOpen && (
          <button
          ...
          >
            <div className="flex items-center gap-0.5">
              ...
              <div className="w-2 h-2 rounded-full border border-white/40" style={{ backgroundColor: '#22c55e' }} />
              <div className="w-2 h-2 rounded-full border border-white/40" style={{ backgroundColor: '#eab308' }} />
              <div className="w-2 h-2 rounded-full border border-white/40" style={{ backgroundColor: '#f97316' }} />
            </div>
            {t.legendToggle}
          </button>
        )}
            ...
            <div className="bg-background/95 backdrop-blur-sm rounded-lg p-3 shadow-lg max-w-[180px]">
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  ...
                  aria-label={lang === 'it' ? 'Chiudi legenda' : 'Close legend'}
                >
                  <X className="w-3 h-3" />
                </button>
              </div>
