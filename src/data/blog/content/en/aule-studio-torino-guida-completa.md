...
✅ Comala (350 heated outdoor seats)
...
1. **Campus Piemonte** - Real-time EDISU hall booking
2. **Affluences** - UniTo library booking + live occupancy
3. **Biblioteche Civiche Torinesi** - Public library hours and bookings
4. **GTT Mobile** - Turin public transport
5. **Study in Torino** - Complete Diffused Campus map
...
1. **Change environment every 2-3 hours** - Science shows changing space helps memorization
2. **Alternate silent and social spaces** - Libraries for concentration, Diffused Campus for group work
3. **Use Pomodoro technique** - 25 min study + 5 min break (perfect in bars and cafés)
4. **Always book when possible** - EDISU halls and UniTo libraries fill up quickly
5. **Download offline maps** - Some spaces are hidden, useful to have GPS coordinates

### **Mistakes to avoid:**

❌ Going to library without booking (UniTo and EDISU)  
❌ Studying in noisy bars for difficult exams  
❌ Not downloading booking apps  
❌ Ignoring Diffused Campus (underrated and fantastic spaces!)

---

## 🏠 Looking for Accommodation in Turin?

If you're looking for a study space, you're probably also looking for accommodation! **JungleRent** is the innovative platform connecting Politecnico and UniTo students with the best accommodations in Turin.

### **Why choose JungleRent:**

✅ **Close to universities** - Strategic accommodations near PoliTo, UniTo and best study spaces  
✅ **Transparent contracts** - Zero tricks, everything clear from day one  
✅ **24/7 assistance** - Dedicated team for any problem  
✅ **Student community** - Join the JungleRent community
...
We're working on an **interactive map** with all 57 Turin study spaces, filterable by:
- Capacity
- Hours (24h, evening, weekend)
- Wi-Fi (free/paid)
- Noise level
- Booking required
...
Campus Piemonte (iOS and Android). It's mandatory for Buonarroti and Verdi Halls.

### **2. Are public libraries free?**
Yes, all public libraries are completely free and open to everyone.

### **3. Can I study in groups at university libraries?**
No, libraries require silence. For group work use Diffused Campus or bars.

### **4. Where can I study for free until late?**
EDISU Buonarroti and Verdi Halls (until 2:00 AM during exam period), Comala (until 0:30).

### **5. What is the University Diffused Campus?**
A Turin-unique project: public spaces transformed into informal study rooms. 11 free locations.

### **6. Where can I study outdoors?**
Valentino Park, Colletta Park, Imbarchino, Comala (350 heated outdoor seats).

### **7. Do I need a university card to access libraries?**
- **EDISU**: No, but booking required for some halls
- **Politecnico**: Yes, only for PoliTo students
- **UniTo**: Yes, with university credentials
- **Public**: No, open to everyone

---

## 📚 Useful Resources

- [EDISU Piemonte](https://www.edisu.piemonte.it) - Study halls and student services
- [Turin Public Libraries](https://bct.comune.torino.it) - Public library network
- [Politecnico Libraries](https://www.biblio.polito.it) - PoliTo library system
- [UniTo Libraries](https://www.sba.unito.it) - 22 specialized libraries
- [Study in Turin](https://www.studyintorino.it) - University Diffused Campus
- [City of Turin](https://www.comune.torino.it/cultura/biblioteche/) - Culture and libraries

---

## 🎓 Conclusion

Turin offers **57 diversified study spaces** for every need: from historic libraries to parks with Wi-Fi, from Diffused Campus to professional coworking spaces. Whether you're a Politecnico or University of Turin student, you now have the **complete guide** to find your perfect space.

**Final tip:** Experiment with different spaces in the first weeks and create your personal "study circuit" alternating environments based on your daily needs.

📍 **Download complete CSV:** [Turin Study Spaces](/resources/aule_studio_torino.csv)
