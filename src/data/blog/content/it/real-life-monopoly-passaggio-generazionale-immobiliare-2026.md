...
Da una parte ricchezza ferma. Dall'altra domanda insoddisfatta. **Il mercato ha un problema di utilizzo, più che di quantità di case.**
...
Un'ondata di 2.720 miliardi di euro di immobili in transizione è il contesto in cui un modello come il nostro acquista senso strategico. Nei prossimi anni arriverà sul mercato, per vendita o per disinteresse degli eredi, una quantità di appartamenti urbani senza precedenti. Molti finiranno per restare vuoti. Alcuni verranno svenduti. Pochi verranno **riqualificati e rimessi in funzione** da chi ha un metodo per farlo.

Jungle Rent nasce per essere tra questi ultimi. L'obiettivo è fare un lavoro che il mercato lascia scoperto: trasformare un patrimonio fermo in alloggi che servono davvero, un appartamento alla volta, a partire da Torino.

---

## Una nota di onestà {#onesta}

I numeri grandi sono affascinanti, e proprio per questo vanno maneggiati con prudenza. 2.720 miliardi valgono molto meno in termini di opportunità reali: la stragrande maggioranza di quelle case resterà in famiglia, fuori mercato, o in zone senza domanda. Il valore reale sta nella **capacità di selezionare il singolo immobile giusto** (posizione, prezzo, sostenibilità della gestione) e di gestirlo con disciplina.

È un lavoro fatto di una proprietà alla volta. Ed è proprio in un mercato che si muove così tanto che la differenza tra chi seleziona bene e chi compra a caso diventa enorme.
